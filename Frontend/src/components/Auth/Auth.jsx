...
//         {mode === "login" ? (
//           <div
//             className={`image-content ${animationStage === "login" ? "active" : animationStage === "transition" ? "fade-out" : "hidden"}`}
//           >
//             <div className="image-placeholder">
//               <div className="gif-container">
//                 <img
//                   src="/src/assets/wos-gif.gif"
//                   alt="Work Order System Animation"
//                   className="wos-gif"
//                 />
//                 <div className="gif-overlay"></div>
//               </div>
//               <h3>Welcome Back!</h3>
//               <p>Access your dashboard and manage item codes efficiently.</p>
//             </div>
//           </div>
//         ) : (
//           <div
//             className={`form-content ${animationStage === "register" ? "slide-in" : animationStage === "transition" ? "slide-out" : "hidden"}`}
//           >
//             <div className="form-wrapper">
//               <div className="form-header">
//                 <h2 className="app-title">Work Order System</h2>
...
//         {mode === "login" ? (
//           <div
//             className={`form-content ${animationStage === "login" ? "active" : animationStage === "transition" ? "slide-out" : "hidden"}`}
//           >
//             <div className="form-wrapper">
//               <div className="form-header">
...
//         ) : (
//           <div
//             className={`image-content ${animationStage === "register" ? "slide-in" : animationStage === "transition" ? "fade-out" : "hidden"}`}
//           >
//             <div className="image-placeholder">
//               <div className="gif-container">
//                 <img
...
//               <h3>Join Us Today!</h3>
//               <p>
//                 Create an account to start managing work orders and streamline
//                 your workflow.
//               </p>
//             </div>
//           </div>
